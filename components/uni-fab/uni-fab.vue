	...
	<view @tap="onMessageClick">
        ...
        rightTop: rightTop
          ...
          right: horizontal === 'right' && direction === 'horizontal'
				...
				<text :class="{ active: isShow }" class="iconfont message-icon" v-if="num > 0" style="color: red">&#xe69a;</text>
				<text :class="{ active: isShow }" class="iconfont message-icon" v-else>&#xe69a;</text>
